...
class JD_crawl:
    ...
    def get_login_info(self):
        ...
        data = {
            'uuid': uuid,
            'eid': 'HHXEF3R72DPEO5UIHEECMKFDC4CFYP6I3VJEXWMB55LXJEYEH2XW7XRDHQY44PY75WEKREHGK6GNOEBOON2W7G2PMA',
            'fp': '53cfb4687791b2080dc6586fe5a51d9c',
            '_t': _t,
    ...
    def login(self):
        ...
        try:
            login_page = self.session.post(
                self.post_url, data=data, headers=headers)
    ...
    def shopping(self):
        login = self.session.post(
            'https://cart.jd.com/cart.action', headers=self.headers)
